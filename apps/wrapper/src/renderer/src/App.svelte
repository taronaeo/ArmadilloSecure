...
<div class="container">
  ...
  <p class="hero-tagline">
    Please try pressing <code>F12</code>
    to open the devTool
  </p>

  <div class="links">
    <div class="link-item">
      <a rel="noopener noreferrer" target="_blank" href="https://electron-vite.org">
        Documentation
      </a>
    </div>
  ...
  <div class="features">
    <div class="feature-item">
      <article>
        ...
        <p class="detail">
          Config with <span>electron.vite.config.ts</span>
          and refer to the
    ...
    <div class="feature-item">
      <article>
        ...
        <p class="detail">
          Run <span>'electron-vite dev --watch'</span>
          to enable. See
          <a
            rel="noopener noreferrer"
            target="_blank"
    ...
    <div class="feature-item">
      <article>
        ...
        <p class="detail">
          Check out <span>.vscode/launch.json</span>
          . See
          <a
            rel="noopener noreferrer"
            target="_blank"
