<script lang="ts">
    ...
    let proceedToAuth: boolean = false;
...
<div class:hidden={proceedToAuth}>
{#if failedCheck}
<Failed/>
        ...
        <br>
          <div>
            ...
            <ul class="list-decimal list-inside">
                <li>Performed a <span class="font-bold">FULL</span> scan in the past <span class="text-secondary">24 hours</span></li>
                <li>Antivirus signatures must be updated in the past <span class="text-secondary">1 month</span> </li>
            </ul>
          </div>
          <div class="my-8 text-center">
            <button on:click={checkCompromisation} on:click={() => {proceedPressed=true;}} class="btn bg-secondary text-neutral w-24">
                {#if !proceedPressed}
                Check Defender
