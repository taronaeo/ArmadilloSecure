...
<body class="flex items-center justify-center h-screen">
    ...
    <!-- Login Form - Card -->
    <div class="w-4/12 p-10 border border-primary rounded-md shadow-lg">

        <!-- Login Form - Header -->
        <p class="text-3xl font-semibold text-center mb-5">
            Welcome Back
        </p>
        ...
        <div>
            <label class="form-control w-full max-w-md">
                ...
                <input type="text" placeholder="Name@example.com" class="input input-bordered w-full max-w-md 
        ...
        <!-- Login Form - Submit/Continue Button -->
		{#if !confirm}
            <button
                type="submit"
        ...
        <!-- Login Form - Submit/Continue Button with animation -->
        {:else}
        ...
        <p class="text-center">
            ...
            <a class="text-primary hover:text-accent duration-300" href="/signup">
                Sign up
            </a>
        </p>
